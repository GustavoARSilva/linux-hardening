...
| :------------: | :----------------: | :------------: | :----------------: |
| pending | 5.7.y (pending) | 1394 | [5.6.y](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/log/?qt=author&q=Gustavo+A.+R.+Silva&h=linux-5.6.y) | 
