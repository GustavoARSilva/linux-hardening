...
| :------------: | :----------------: | :------------: | :----------------: |
| [1,917](https://github.com/torvalds/linux/graphs/contributors) | [5.9.y](comming soon...) | 1,764 | [5.8.y](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/log/?qt=author&q=Gustavo+A.+R.+Silva&h=linux-5.8.y) |
