...
| :------------: | :----------------: | :------------: | :----------------: |
| [2.077](https://github.com/torvalds/linux/graphs/contributors) | [5.11.y](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/log/?qt=author&q=Gustavo+A.+R.+Silva&h=linux-5.11.y) | 1,942 | [5.10.y](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/log/?qt=author&q=Gustavo+A.+R.+Silva&h=linux-5.10.y) |
